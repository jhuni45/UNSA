...
void UnitVectorPP(int *ierr, float *wx, float *wy, float *wz, float ax, float ay, float az, float bx, float by, float bz) {
    if (*ierr) return;
    *wx = bx - ax;
    *wy = by - ay;
    *wz = bz - az;
...
void UnitVectorVV(int *ierr, float *wx, float *wy, float *wz, float ux, float uy, float uz, float vx, float vy, float vz) {
    if (*ierr) return;
    *wx = uy * vz - uz * vy;
    *wy = uz * vx - ux * vz;
    *wz = ux * vy - uy * vx;
